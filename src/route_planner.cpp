...
// Tips:
// - Use the () method ofFindNeighbors the current_node to populate current_node.neighbors vector with all the neighbors.
// - For each node in current_node.neighbors, set the parent, the h_value, the g_value. 
// - Use CalculateHValue below to implement the h-Value calculation.
// - For each node in current_node.neighbors, add the  neighborto open_list and set the node's visited attribute to true.
...
RouteModel::Node *RoutePlanner::NextNode() {
    ...
    RouteModel::Node * ElectedNode;
    ElectedNode =this->open_list.back();
...
void RoutePlanner::AStarSearch() {
    RouteModel::Node *current_node = this->start_node;//nullptr;
